...
(function(Bayes) {
  ...
  Bayes.Node=function(n,v) {
    //web.archive.org/web/20160310082821/https://if (arguments.length==3) this.set3(arguments[0],arguments[1],arguments[2]);
    this.name=n;
    this.values=v;
    this.value=-1;
    this.parents=[];
  ...
  Bayes.Node.prototype.sampleLw=function() {
    ...
    var dh=this.cpt;
    for (var h=0;h<this.parents.length;h++) {
        if (typeof(dh[this.parents[h].value]) !== "undefined") {
            dh = dh[this.parents[h].value];
        }
    }
